...
struct lcu_item 
{
  ...
  int hash;
  LCUWT delta;
  GK<long double>* qsketch;//Added
  unsigned long long timestamp;//Added
  LCUGROUP *parentg;
...
extern void LCU_Update(LCU_type *, uint64_t);
extern void LCU_UpdateLatency(LCU_type *, uint64_t, long double);
extern long double LCU_QuantileQuery(LCU_type * lcu, uint64_t newitem, double rank);
extern long double LCU_QuantileQuerywGsamples(LCU_type * lcu, uint64_t newitem, double rank);
...
extern void LCU_ShowGroups(LCU_type * lcu);
